 ...
 */
public class RSThin extends TextView {
    String fongUrl = "fonts/RobotoSlab-Thin.ttf";

    public RSThin(Context context) {
        super(context);
        init(context);
    }

    public RSThin(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public RSThin(Context context, AttributeSet attrs, int defSyle) {
